...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("awww img ~/Pictures/wallpapers/gruv_sushi_streets.jpg")
    hl.exec_cmd("mako")
end)
...
hl.config({
    general = {
        ...
        col              = {
            active_border   = { colors = { "rgba(fe8019)" }, angle = 45 },
            inactive_border = "rgba(282828)",
        },
    ...
    decoration = {
        ...
        blur             = {
            ...
            -- blur behind the special workspace
            special  = true,
        },
    },
